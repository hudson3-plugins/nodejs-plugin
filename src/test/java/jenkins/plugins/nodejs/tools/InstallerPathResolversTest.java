...
public class InstallerPathResolversTest {
    ...
    public static Collection<Object[]> data() throws IOException {
        ...
        for(int i=0; i<installables.size(); i++){
            DownloadFromUrlInstaller.Installable installable = (DownloadFromUrlInstaller.Installable)JSONObject.toBean(installables.getJSONObject(i), DownloadFromUrlInstaller.Installable.class);
